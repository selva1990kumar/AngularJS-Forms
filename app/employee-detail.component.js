...
var EmployeeDetailComponent = (function () {
    function EmployeeDetailComponent(_employeeserv) {
        this._employeeserv = _employeeserv;
        this.userForm = new forms_1.FormGroup({
            name: new forms_1.FormControl('modelDrivenFormUserName', [forms_1.Validators.required, forms_1.Validators.minLength(4), forms_1.Validators.maxLength(40)]),
    ...
    EmployeeDetailComponent.prototype.onSubmit = function () {
