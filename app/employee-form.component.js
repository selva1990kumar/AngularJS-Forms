...
var EmployeeFormComponent = (function () {
    function EmployeeFormComponent(_formBuilder) {
        this._formBuilder = _formBuilder;
    }
    EmployeeFormComponent.prototype.ngOnInit = function () {
        this.userForm = this._formBuilder.group({
            name: ['ModelDrivenFormWithFormBuilder', [forms_1.Validators.required, forms_1.Validators.minLength(4), forms_1.Validators.maxLength(40)]],
            email: [],
